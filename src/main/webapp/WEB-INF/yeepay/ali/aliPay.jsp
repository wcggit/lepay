...
<script type="text/javascript">
    ...
    function pay() {
        ...
        if (${aliUser!=null}) { //非会员消费
            if(${scorea.score!=0}){
                var str = "${aliUser.leJiaUser.userSid} "+totalPrice+" ${merchant.id}"
                var ext = ljhash(str, "lepluslife");
                ...
                var ext = ljhash(totalPrice + " 0"
                                 + " ${aliUser.leJiaUser.userSid} ${merchant.id} " + totalPrice, "lepluslife");
            ...
            location.href = "/pay/yeepay/alipay/user?totalPrice=" + totalPrice+"&userId=${userId}&merchantSid=${merchant.merchantSid}";
        }
    }
