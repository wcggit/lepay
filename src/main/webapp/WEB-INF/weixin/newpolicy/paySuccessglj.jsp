    ...
    <div class="modle-wrapper clearfix">
        <div class="modle-main">
            ...
            <div class="modle-bottom">
                ...
                <p>
                    二、<br>没有指定鼓励金核销日！随时可用！
                </p>

                <p>
                    三、<br>鼓励金不过期！直接存入您的鼓励金账户！绝不清零！
                </p>
            </div>
        </div>
    </div>
                ...
                <ul class="week-list">
                    ...
                    <li class="week-item clearfix today">
                            ...
                            <span class="left"><a class="day">周一</a>
                                ...
                                <a class="date">${weekends[0]}</a>
                            </span>
                                    <c:if
                                            test="${dailyRebate[0]['value']=='0'}"><span
                                        class="right no-money">未支付</c:if>
                                    <c:if
                                            test="${dailyRebate[0]['value'] !='0'}"><span
                                            class="right money">¥${dailyRebate[0]['value']}</c:if> </span>
                                </li>
                                <c:if test="${day==3}">  <li class="week-item clearfix today">
                            <span class="left"><a class="day">今日</a>
                                </c:if>
                                <c:if test="${day!=3}">  <li class="week-item clearfix">
                            <span class="left"><a class="day">周二</a>
                                </c:if>
                                <a class="date">${weekends[1]}</a>
                            </span>
                                    <c:if test="${dailyRebate[1]!=null}">
                                    <c:if
                                            test="${dailyRebate[1]['value']=='0'}"><span
                                        class="right no-money">未支付</c:if>
                                    <c:if
                                            test="${dailyRebate[1]['value'] !='0'}"><span
                                        class="right money">¥${dailyRebate[1]['value']}</c:if></span></c:if>
                                    <c:if test="${dailyRebate[1]==null}"> <span
                                            class="right no-money">支付后领取</span></c:if>
                                </li>
                                <c:if test="${day==4}"> <li class="week-item clearfix today">
                            <span class="left"> <a class="day">今日</a>
                                </c:if>
                                <c:if test="${day!=4}">
                                <li class="week-item clearfix">
                                    ...
                                    <a class="date">${weekends[2]}</a></span>
                                    <c:if test="${dailyRebate[2]!=null}">
                                    <c:if
                                            test="${dailyRebate[2]['value']=='0'}"><span
                                        class="right no-money">未支付</c:if>
                                    <c:if
                                            test="${dailyRebate[2]['value'] !='0'}"><span
                                        class="right money">¥${dailyRebate[2]['value']}</c:if></span></c:if>
                                    <c:if test="${dailyRebate[2]==null}"> <span
                                            class="right no-money">支付后领取</span></c:if>
                            </span>
                                </li>
                    <li class="week-item clearfix">
